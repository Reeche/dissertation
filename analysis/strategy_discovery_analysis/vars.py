...
# se_pid = [2, 5, 11, 15, 18, 27, 28, 48, 50, 53, 55, 56, 57, 62, 69, 70, 72, 76, 81, 82, 88, 89, 103, 105, 109, 111, 112,
...
# pr_se_pid = [12, 14, 22, 25, 36, 58, 66, 86, 90, 95, 101, 117, 173, 176, 197, 210, 224, 234, 237, 238, 240, 251, 256,
...
# td_se_pid = [52, 74, 183, 212, 233, 298]  # n=6
# pr_se_td_pid = [59, 204]
...
habitual_model = ["Habitual"]
ssl_model = ["SSL"]
non_learning_model = ["Non-learning"]
...
diss_mb = [5, 12, 13, 15, 21, 42, 44, 47, 61, 66, 69, 74, 79, 81, 84, 87, 88, 104,
           105, 112, 127, 130, 136, 144, 160, 163, 168, 176, 182, 197, 198, 224, 225, 248,
           251, 258, 269, 270, 272, 273, 283, 284, 285, 288, 290, 298, 301, 302, 303, 314,
           325, 326, 345, 351]

diss_mf = [2, 8, 24, 43, 48, 49, 54, 62, 68, 73, 75, 80, 85, 91, 93, 96, 99, 102,
           107, 110, 113, 116, 117, 120, 123, 124, 126, 131, 137, 145, 147, 149, 153, 156,
           159, 166, 169, 171, 172, 178, 181, 183, 185, 187, 190, 199, 200, 207, 212, 213,
           220, 221, 226, 229, 233, 242, 244, 246, 247, 252, 261, 263, 266, 274, 279, 286,
           287, 294, 295, 296, 306, 319, 333, 337, 340, 365, 367, 369, 372, 376, 378]

diss_non_learning = [18, 28, 32, 38, 56, 63, 72, 77, 82, 90, 103, 109, 122, 152, 173, 196,
                     239, 256, 275, 278, 309, 311, 315, 335, 336, 342, 346, 352, 353, 354, 371]

diss_hybrid = [3, 4, 6, 7, 9, 16, 17, 19, 23, 30, 34, 35, 41, 45, 53, 57, 58, 67, 71, 76,
...
diss_habitual = [1, 10, 11, 14, 20, 22, 25, 26, 27, 29, 33, 36, 37, 39, 40, 46, 50, 51, 52,
                 55, 59, 65, 70, 89, 95, 98, 101, 111, 115, 118, 119, 125, 129, 134, 135, 140,
                 142, 148, 151, 154, 162, 170, 180, 186, 192, 193, 202, 204, 205, 209, 210, 214,
                 215, 217, 234, 235, 237, 240, 241, 249, 253, 254, 257, 265, 268, 271, 276, 277,
                 282, 289, 300, 304, 308, 312, 313, 321, 322, 323, 329, 330, 331, 332, 339, 343,
                 348, 358, 363, 364, 370]

# only contain learners
diss_habitual_not_examined_all = [265, 10, 11, 268, 14, 271, 277, 25, 26, 27, 29, 33, 289, 36, 37, 39, 40, 300, 46, 304,
                                  51, 52, 308, 55, 312, 59, 65, 321, 322, 323, 70, 329, 330, 339, 89, 348, 95, 98, 101,
                                  364, 115, 118, 119, 125, 134, 140, 154, 162, 170, 180, 186, 192, 193, 202, 204, 205,
                                  209, 214, 215, 217, 235, 237, 240, 241, 249, 253, 254]
diss_habitual_examined_all = [1, 129, 257, 135, 142, 20, 148, 22, 151, 276, 282, 50, 313, 331, 332, 210, 343, 358, 234,
                              363, 111, 370]

diss_mcrl_examined_all = [2, 344, 68, 164, 166, 228, 324, 172, 45, 80, 340, 213, 372, 24, 88, 189]
diss_mcrl_not_examined_all = [3, 4, 5, 6, 7, 8, 9, 12, 13, 15, 16, 17, 19, 21, 23, 30, 34, 35, 41, 42, 43, 44, 47, 48,
                              49, 53, 54, 57, 58, 61, 62, 66, 67, 69, 71, 73, 74, 75, 76, 78, 79, 81, 83, 84, 85, 86,
                              87, 91, 92, 93, 96, 99, 102, 104, 105, 106, 107, 110, 112, 113, 116, 117, 120, 123, 124,
                              126, 127, 128, 130, 131, 133, 136, 137, 138, 139, 141, 143, 144, 145, 146, 147, 149, 153,
                              155, 156, 159, 160, 161, 163, 165, 167, 168, 169, 171, 174, 175, 176, 177, 178, 181, 182,
                              183, 184, 185, 187, 190, 194, 195, 197, 198, 199, 200, 201, 203, 206, 207, 211, 212, 216,
                              218, 219, 220, 221, 223, 224, 225, 226, 229, 231, 232, 233, 236, 238, 242, 244, 246, 247,
                              248, 250, 251, 252, 255, 258, 259, 260, 261, 262, 263, 266, 267, 269, 270, 272, 273, 274,
                              279, 280, 281, 283, 284, 285, 286, 287, 288, 290, 291, 292, 293, 294, 295, 296, 298, 299,
                              301, 302, 303, 305, 306, 310, 314, 316, 317, 318, 319, 320, 325, 326, 327, 328, 333, 337,
                              341, 345, 347, 349, 350, 351, 355, 356, 357, 359, 360, 361, 362, 365, 367, 369, 373, 374,
                              375, 376, 377, 378]
