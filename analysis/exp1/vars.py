...
hvhc = {
    ...
    "MB - Equal, ind.": [49, 134],
    "MB - Uniform, grouped": [70, 182],
    "hybrid Reinforce": [83, 195],
    "MF - Reinforce": [108],
    "MB - Uniform, ind.": [109, 111, 114, 149],
    "MB - Equal, grouped": [164],
    "MF - LVOC": [177],
}

hvlc = {
    "MB - Uniform, ind.": [4, 48, 58, 82, 92, 136, 151],
    "MB - Level, ind.": [7, 145, 189],
    "MB - Equal, ind.": [8],
    "Non-learning": [17, 23, 154, 180],
    "Habitual": [35, 96],
    "hybrid LVOC": [50],
    "MB - Uniform, grouped": [51, 93, 126, 141],
    "hybrid Reinforce": [53],
    "MB - Equal, grouped": [71],
