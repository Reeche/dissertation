...
def test_models(
    ...
    mf = ModelFitter(exp_name, number_of_trials=35)
...
random_models = np.random.choice(range(2016), 200)
...
class TestModels(unittest.TestCase):
    ...
    def test_mcrl_project_models(self, model_index, optimization_params):
        ...
        """
        test_models("v1.0", 121, [model_index], optimization_params=optimization_params)
