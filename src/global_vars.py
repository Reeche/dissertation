...
class structure:
    ...
    '''
    exp_pipelines = pickle.load(open("data/exp_pipelines.pkl","rb"))
...
class strategies:
    ...
    strategy_weights = pickle.load(open("data/microscope_weights.pkl", "rb"))
    strategy_distances = pickle.load(open("data/L2_distances.pkl", "rb"))


class features:
    microscope = pickle.load(open("data/microscope_features.pkl", "rb")) # this is 51 features
    implemented = pickle.load(open(f"data/implemented_features.pkl", "rb"))  # this is 56 features
