...
def analysis_change_percentage(exp_num, block):
    if exp_num == "c2.1":
        strategies = learning_utils.pickle_load(f"../results/cm/inferred_strategies/c2.1_dec_{block}/strategies.pkl")
    else:
        strategies = learning_utils.pickle_load(f"../results/cm/inferred_strategies/{exp_num}_{block}/strategies.pkl")
